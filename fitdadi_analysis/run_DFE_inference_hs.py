...
spectra_h_1=pickle.load(open('{directory_spectra}/spectra_h{coef}_s0.25.sp'.format(directory_spectra=directory_spectra, coef=h1),'rb'))
spectra_h_2=pickle.load(open('{directory_spectra}/spectra_h{coef}_s0.25.sp'.format(directory_spectra=directory_spectra, coef=h2),'rb'))
spectra_h_3=pickle.load(open('{directory_spectra}/spectra_h{coef}_s0.25.sp'.format(directory_spectra=directory_spectra, coef=h3),'rb'))
spectra_h_4=pickle.load(open('{directory_spectra}/spectra_h{coef}_s0.25.sp'.format(directory_spectra=directory_spectra, coef=h4),'rb'))
spectra_h_5=pickle.load(open('{directory_spectra}/spectra_h{coef}_s0.25.sp'.format(directory_spectra=directory_spectra, coef=h5),'rb'))
...
df_discrete.to_csv('{directory_results}/DFE_inference_discrete_s0.25_{h1}_{h2}_{h3}_{h4}_{h5}.csv'.format(directory_results=directory_results, h1=h1, h2=h2, h3=h3, h4=h4, h5=h5), index=False)
