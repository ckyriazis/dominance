...
discrete_0.0 <- read.csv("DFE_inference_discrete_0.00_constrained.csv")
discrete_0.05 <- read.csv("DFE_inference_discrete_0.05_constrained.csv")
discrete_0.10 <- read.csv("DFE_inference_discrete_0.10_constrained.csv")
discrete_0.15 <- read.csv("DFE_inference_discrete_0.15_constrained.csv")
discrete_0.25 <- read.csv("DFE_inference_discrete_0.25_constrained.csv")
discrete_0.35 <- read.csv("DFE_inference_discrete_0.35_constrained.csv")
discrete_0.45 <- read.csv("DFE_inference_discrete_0.45_constrained.csv")
discrete_0.50 <- read.csv("DFE_inference_discrete_0.50_constrained.csv")
discrete_0.75 <- read.csv("DFE_inference_discrete_0.75_constrained.csv")
discrete_1.0 <- read.csv("DFE_inference_discrete_1.0_constrained.csv", )
...
pdf("discrete_plot.pdf", width = 14, height = 6)
...
barplot(bars, beside=T, xlab = "Selection coefficient bin", ylab = "Proportion",cex.axis=axis, cex.lab=lab, names.arg = c("(0,1e-5]","(1e-5,1e-4]","(1e-4,1e-3]","(1e-3,1e-2]","(1e-2,0.5]"), col = cols, cex.names = 1.0)
legend("topright",  fill = cols, c("0.0","0.05","0.10","0.15","0.25","0.35","0.45","0.50","0.75","1.0"), cex=1.3, bty="n")
...
gamma_0.0 <- read.csv("DFE_inference_gamma_0.00.csv")
gamma_0.05 <- read.csv("DFE_inference_gamma_0.05.csv")
gamma_0.10 <- read.csv("DFE_inference_gamma_0.10.csv")
gamma_0.15 <- read.csv("DFE_inference_gamma_0.15.csv")
gamma_0.25 <- read.csv("DFE_inference_gamma_0.25.csv")
gamma_0.35 <- read.csv("DFE_inference_gamma_0.35.csv")
gamma_0.45 <- read.csv("DFE_inference_gamma_0.45.csv")
gamma_0.50 <- read.csv("DFE_inference_gamma_0.50.csv")
gamma_0.75 <- read.csv("DFE_inference_gamma_0.75.csv")
gamma_1.0 <- read.csv("DFE_inference_gamma_1.0.csv")
...
setwd("~/Documents/UCLA/dominance/analysis/plots/")
pdf("gamma_plot.pdf", width = 14, height = 6)
par(mfrow=c(1,2), mar = c(4,4.5,1,1))
